...
j3r.MarkersController = (function() {
  MarkersController.wrapper = 'selectors-wrapper';
  ...
  MarkersController.prototype.setSelections = function(mainCategory, selection) {
    ...
    if (wrapper.children('.selectors-wrapper').length > 0) {
      wrapper.children('.selectors-wrapper').empty();
    }
  ...
  MarkersController.prototype.getParentId = function(categoryId) {
    ...
    parrentId = mainCatEnd !== -1 ? 'wrapper-' + categoryId.substr(0, mainCatEnd) : 'selectors-wrapper';
    return parrentId;
  };
